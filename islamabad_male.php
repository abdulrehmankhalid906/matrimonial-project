    ...
    <div class="container" style="background-color: white; border-left:1px solid black;border-right:1px solid black;">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 py-3">
          <h2 class="fw-bold">All Proposals<small class="text-danger"><i>(Islamabad Male Proposals)</i></small></h2>
        ...
        <div class="col-lg-12 col-md-12 col-sm-10">
          <div class="table-responsive">
            <table class="table table-borderless">
              <tbody>
                <?php
                $query = "select * from registerinfo Where city='islamabad' AND gender='male'";
