    ...
    <div class="container" style="background-color: white; border-left:1px solid black;border-right:1px solid black;">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 py-3">
              ...
              <a href="rawalpindi_male.php" class="btn btn-success">Rawalpindi Male Proposals</a>
              <a href="rawalpindi_female.php" class="btn btn-success">Rawalpindi Female Proposals</a>
            </div>
        </div>
